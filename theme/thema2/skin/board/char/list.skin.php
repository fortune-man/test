...
<div id="bo_list" style="width:<?php echo $width; ?>; overflow:auto;">
    ...
    <div class="bo_fx">
        <div id="bo_list_total">
			...
			<div style="margin:5px 0;">
				<button type="button" onclick="javascript:set_date('오늘');" class="btn_b02">오늘</button>
				<button type="button" onclick="javascript:set_date('어제');" class="btn_b02">어제</button>
				<button type="button" onclick="javascript:set_date('이번주');" class="btn_b02">이번주</button>
				<button type="button" onclick="javascript:set_date('이번달');" class="btn_b02">이번달</button>
				<button type="button" onclick="javascript:set_date('지난주');" class="btn_b02">지난주</button>
				<button type="button" onclick="javascript:set_date('지난달');" class="btn_b02">지난달</button>
				<button type="button" onclick="javascript:set_date('전체');">전체</button>
				<input type="submit" value="검색" class="btn_admin">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
				<th scope="col">No</th>
				<th scope="col">날짜</th> 
		<th scope="col">제목</th>				 	 <!-- subject -->             
		<th scope="col">이름</th>				 <!-- 1 -->
				<th scope="col">생년월일</th>					 <!-- 2 -->
				<th scope="col">아이디</th>					 <!-- 3 -->
				<th scope="col">주소</th> 				 <!-- 4 -->                 
				<th scope="col">기타정보</th>					 <!-- 5 -->                
				<!--
				<th scope="col">필드6</th>					
				<th scope="col">필드7</th>					
				<th scope="col">필드8</th>					
