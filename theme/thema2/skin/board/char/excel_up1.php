...
<div class="new_excel">
    ...
    <div id="excelfile_upload" style="text-align:center;width:300px;">
        <label for="excelfile">파일유형 선택</label>
		<input type="radio" name="ex_type" value="1"><label for="ex_type">신규파일</label>
		수정파일<input type="radio" name="ex_type" value="2"> 
